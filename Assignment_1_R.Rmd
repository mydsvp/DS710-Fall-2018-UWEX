...
sd: this fucction computes the standard deviation of the values in parameter x
...
- Then save the .Rmd file and the .pdf or Word document in the same folder where you downloaded the homework from GitHub.  
- Use the GitHub desktop console to commit your changes.  
- Then go to the GitHub website and create a pull request.  
- If you can see your submission on the Pull Requests page for this assignment (https://github.com/uwexds710fall2018/ds710fall2018assignment1/pulls), then you have submitted it successfully.
